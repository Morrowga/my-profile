...
const PROJECTS = [
    {
      id: 14,
      title: 'Levelt - AI-powered exam & interview prep',
      subtitle: 'Practice questions for tech roles, generated once and shared across every learner in the same stack',
      description: 'Levelt serves practice questions organized by tech role — Frontend Engineer, Backend Engineer, and more — each broken into specific stacks like React, Python, or SQL. Questions are generated once by AI and pooled for every user in that stack, deduplicated by embedding similarity so nobody sees a near-identical question twice, then independently verified by a second AI pass before ever entering the pool. Correct answers earn wisdom points weighted by difficulty, feeding a rank system (Rare through Champion) that requires real accuracy at the hardest tier, not just answer volume, to reach the top. Users can download a certificate per position summarizing their rank, accuracy, and the stacks that contributed to it. A background pool-warming system keeps active categories topped up automatically, and the client chains prefetch requests so consecutive questions load instantly after the first.',
      tags: ['TypeScript', 'React Native', 'Expo', 'Zustand', 'Python', 'FastAPI', 'PostgreSQL', 'pgvector', 'OpenAI'],
      accent: 'var(--accent)',
      status: 'Ready To Ship',
      year: '2026',
      github: { disabled: false, repo: 'Morrowga' },
      website: { show: false, url: '', name: 'Levelt' },
      imageCount: 6,
      imageDir: '14',
    },
    {
      id: 13,
      title: 'CallConfirm - Automated appointment confirmation calls',
      subtitle: 'AI-voiced phone calls that confirm appointments so businesses stop losing money to no-shows',
      description: 'CallConfirm places automated phone calls to confirm upcoming appointments, letting customers respond by keypress or voice message instead of requiring manual follow-up calls. Businesses schedule appointments individually or via bulk CSV upload, and the platform handles reminder timing, call language, and voice selection per call. Under the hood it uses Twilio for telephony and Amazon Polly for text-to-speech across multiple languages, with an AI step that checks each generated confirmation sentence for language accuracy before a call ever goes out. A full admin panel handles account management, billing, phone number provisioning, and a multi-layer risk-review pipeline that flags suspicious activity before it reaches customers.',
      tags: ['TypeScript', 'React', 'Python', 'FastAPI', 'PostgreSQL', 'Twilio', 'Stripe', 'Celery'],
      accent: 'var(--accent)',
      status: 'Ready To Ship',
      year: '2026',
      github: { disabled: false, repo: 'Morrowga' },
      website: { show: false, url: '', name: 'Call Confirm' },
      imageCount: 5,
      imageDir: '13',
    },
    {
      ...
      year: '2026',
      github: { disabled: false, repo: 'Morrowga' },
      website: { show: false, url: '', name: 'ANTS' },
      imageCount: 3,
      imageDir: '12',
    },
    {
  ...
  },
  {
    ...
    year: '2026',
    github: { disabled: false, repo: 'Morrowga' },
    website: { show: false, url: '/', name: 'Intellect' },
    imageCount: 4,
    imageDir: '1',
  },
  {
  ...
  },
  {
    id: 3,
    title: 'Plus Impact',
    subtitle: 'Plus Impact - Plus Talent Job Agency',
    description: "Create new pages based on the provided designs for the website. This is for one of the companies I’ve worked with. Also handle SEO performance optimization and implement backend CRUD functionality.",
    tags: ['React', 'NodeJs','Prisma'],
    accent: 'var(--accent)',
    status: 'Production',
    year: '2025',
    github: { disabled: false, repo: 'Morrowga' },
    website: { show: true, url: 'https://plustalent.co', name: 'Plus Impact' },
    imageCount: 1,
    imageDir: '8',
  },
  {
